...
| image\_config | Container image configuration values that override the values in the container image Dockerfile. | <pre>object({<br>    command           = string<br>    entrypoint        = string<br>    working_directory = string<br>  })</pre> | `null` | no |
